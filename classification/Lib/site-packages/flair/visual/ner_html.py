...
TAGGED_ENTITY = """
<mark class="entity" style="color:#ccb39e; background:#333333; padding: 0.45em 0.6em; margin: 0 0.25em; line-height: 3; border-radius: 0.45em; box-decoration-break: clone; -webkit-box-decoration-break: clone">
    {entity}
    <span style="color:#ffffff; font-size: 0.8em; font-weight: bold; line-height: 3; border-radius: 0.45em; text-transform: uppercase; vertical-align: middle; margin-left: 0.5rem">{label}</span>
</mark>
"""
...
<html style="font-size: 16px;"lang="en">
  <head>
    ...
    <link rel="stylesheet" href="C:/Users/33669/Desktop/NER_page.css" media="screen">
