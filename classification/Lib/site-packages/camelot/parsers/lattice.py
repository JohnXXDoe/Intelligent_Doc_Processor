...
class Lattice(BaseParser):
    ...
    def _generate_table(self, table_idx, cols, rows, **kwargs):
        ...
        table = Lattice._copy_spanning_text(table, copy_text={})  # Get the raw table without filling any blanks
    ...
    def _generate_text(self, table_idx, cols, rows, **kwargs):
        ...
        if self.copy_text is not None:
            table = Lattice._copy_spanning_text(table, copy_text={'h', 'v'})
    ...
    def extract_tables(self, filename, suppress_stdout=False, layout_kwargs={}):
        ...
        for table_idx, tk in enumerate(
            ...
            if table.accuracy > 99 and len(table.data[0][0])<1200:
                #print(f'//--// BBOX VALUES //--// \n>>->>   {table.page}    {len(table.data[0][0])}    \n{table.accuracy} \n\n\n {table.df}')
                txt_table = self._generate_text(table_idx, cols, rows, v_s=v_s, h_s=h_s)
                table._bbox = tk
                _tables.append(table)
                txt_tables.append(txt_table)
            else:
                # warnings.warn(
                #     "LOW ACCURACY SKIPPING TABLE")
                continue
